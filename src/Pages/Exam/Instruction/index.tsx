    ...
    <>
      <div className="sub-container pt-8">
        ...
        <div className="flex flex-col gap-10 mt-6">
          <div>
            <h2 className="font-normal text-lg mb-3">
              1. Practice Actively Label Each Statement True Or False!
            </h2>
            <div className="grid grid-cols-1 2xl:grid-cols-2">
              <div className="border border-card-border p-4 shadow-sm rounded-lg flex max-sm:flex-col justify-center items-center w-full gap-3 question">
                ...
                <div className="flex justify-end max-sm:w-full">
                  <Tooltip
                    title="Click if statement is True"
                    color="#dcfce7"
                    open
                    placement="left"
                    zIndex={40}
                  ...
                  <Tooltip
                    title="Click if statement is False"
                    color="#ffe2e2"
                    open
                    placement="bottom"
                    zIndex={40}
          ...
          <div>
            <h2 className="font-normal text-lg mb-3">
              2. Improve accuracy : use the elimination icon for 50-50 or
              33-33-33!
            </h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
              <div className="border border-card-border p-4 shadow-sm rounded-lg flex max-sm:flex-col justify-center items-center w-full gap-3 question">
                <div className="flex items-center w-full">
                  ...
                  <span className="flex-1 font-medium px-2">
                    Both Statement-1 and statement-2 are correct and Statement-2
                    explains Statement-1
                  </span>
                  <Tooltip
                    title="Click if you want to eliminate option"
                    color="#ffe2e2"
                    open
                    zIndex={40}
                  >
          ...
          <div className="min-h-48">
            <h2 className="font-normal text-lg mb-3">
              3. Strategize Your Answers: Button Actions Explained
            </h2>
              ...
              <div className="flex max-sm:flex-col items-center gap-5">
                ...
                <div className="sm:col-span-2 relative bg-input-box p-3 rounded-lg shadow-md">
                  ...
                  <p className="text-sm text-center sm:text-left">
                    Answer correctly: Earn double marks. Answer wrong: Lose
                    double marks.
                  </p>
                </div>
              </div>
        ...
        <div className="w-full flex justify-end mt-8">
          <FormButton
            ...
            text="NEXT"
            className="custom-button w-full sm:w-40 button button--mimas text-center !p-4 !h-12 uppercase"
          />
        </div>
      </div>
    </>
