    ...
    <>
      <div className="sub-container pt-4 md:pt-8 question-section">
        ...
        <div className="grid grid-cols-1 2xl:grid-cols-6 gap-6 w-full">
            ...
            <div>
              <div className="flex flex-wrap items-center gap-3 mt-3">
                ...
                <Link
                  ...
                  className="bg-input-box font-semibold text-sm p-2 px-4 rounded capitalize"
                >
                  mistake map report
                </Link>
                    ...
                    <div className="bg-white rounded-2xl p-6">
                      ...
                      <ul className="list-[square] ps-5">
                        ...
                        <li className="font-normal">
                          ...
                          <span className="italic font-semibold capitalize">
                            {" "}
                            {formatType(AiMentor?.youStrategy?.type || "")}{" "}
                          </span>
                        </li>
                      </ul>
                    </div>
                      ...
                      {QaAnswers.length > 0 &&
                        (currentQuestion?.questionType === QUE_TYPE.STATEMENT ||
                          ...
                          <div className="space-y-6 pb-6 rounded-2xl">
                            ...
                            <span className="font-bold text-lg rounded">
          ...
          <div
            onClick={() => setOpenQuestion(!isOpenQuestion)}
            className="bg-input-box p-6 rounded-2xl w-full hidden before:fixed before:bg-black before:opacity-40 before:inset-0 before:z-50"
