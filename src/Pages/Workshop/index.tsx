...
const Workshop = () => {
  ...
  return (
    <div className="sub-container space-y-9 py-9 bg-white rounded-xl">
      ...
      <section className="">
        <div className="space-y-6 pb-5">
          ...
          <section className="flex max-sm:flex-col gap-4 justify-between">
            <h1 className="capitalize font-semibold sm:text-2xl">CSAT Live pathshala by madhukar kotawe</h1>
        ...
        <div className="container container-p py-3 sm:py-6 flex max-md:flex-col gap-2 md:gap-4 justify-between md:items-end">
          <div>
            ...
            <h1 className=" sm:text-2xl font-bold flex gap-[2px] items-end">
              <span>₹0</span>
              <span className="text-sm text-gray-400 font-semibold line-through decoration-2 ">500</span>
            </h1>
          </div>
          <div>
          ...
          <div className="md:w-1/4 flex justify-end">
           <FormButton htmlType="submit" text="Enroll Now" className="custom-button button button--mimas w-fit !h-auto" />
