                ...
                HistoryData?.map((item, index) => (
                  <div key={index} className="flex flex-wrap justify-between items-center sm:gap-3 bg-input-box border border-card-border p-3 rounded-lg">
                    <div className="flex justify-between items-center gap-3">
                      ...
                      <div className=" max-lg:max-w-[140px]">
                        <span className="text-md font-bold capitalize block truncate">{item?.title}</span>
                ...
                AllBalanceData?.map((item: any, index: number) => (
                  <div key={index} className="flex flex-wrap justify-between items-center sm:gap-3 bg-input-box border border-card-border p-3 rounded-lg">
                    <div className="flex justify-between items-center gap-3">
                      ...
                      <div className=" max-lg:max-w-[140px]">
                        <span className="text-md font-bold capitalize block truncate">{item?.name}</span>
                    ...
                    <div className="">
                      <p className={`text-base font-bold ${item?.status === "success" ? "text-success" : "text-danger"}`}>₹{item?.amount}</p>
                    </div>
                  </div>
                ))}
            </div>
