...
const KYCVerification = () => {
  ...
  const handleFormSubmit = async (values: any) => {
    ...
    if (!image) {
      return message.warning("Please upload your PAN card first!");
    }
    setOpen(true);
  };
          ...
          >
            ...
            <div className="p-3 sm:p-6 flex flex-col gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <FormButton text="Cancel" htmlType="button" onClick={() => setOpen(false)} className="custom-button-light button button--mimas text-center w-full !p-4 !h-12 uppercase !bg-white" />
                <FormButton text="Done" htmlType="button" onClick={handleKYCVerification} className="custom-button button button--mimas text-center w-full !p-4 !h-12 uppercase !bg-white" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="flex flex-col gap-5">
        ...
        <Form form={form} layout="vertical" onFinish={handleFormSubmit} className="flex flex-col xl:flex-row justify-between gap-10">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 flex flex-1/2 justify-center items-center w-full h-fit ">
            <Image className="w-full max-w-xl rounded-lg object-contain" src={image || "/assets/images/kyc/panCard.png"} />
          </div>
          ...
          <div className="flex flex-col w-full xl:w-1/2 gap-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 justify-between">
              <div className="flex flex-col max-sm:col-span-2 items-center w-full text-center">
                <img src="/assets/images/kyc/panCard.png" alt="Clear" className="w-full h-fit object-cover" />
              ...
              <div className="flex flex-col items-center text-center">
                <img src="/assets/images/kyc/panCardBlur.png" alt="Blurry" className="w-full h-fit object-cover" />
                <p className="text-sm flex items-center mt-1 gap-1">
              ...
              <div className="flex flex-col items-center text-center">
                <img src="/assets/images/kyc/panCardCrop.png" alt="Cropped" className="w-full h-fit object-cover rounded-lg" />
                <p className="text-sm flex items-center mt-1 gap-1">
            ...
            >
              <Dragger {...props}>
                ...
                <p className="ant-upload-hint">SVG, PNG, JPG or PDF (max. 800x400px)</p>
              </Dragger>
            </Form.Item>
