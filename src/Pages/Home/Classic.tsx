    ...
    <>
      <div className="p-5 pt-0">
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
          <div className="flex flex-col items-center gap-4 w-full h-full rounded-2xl p-6 shadow-sm lg:flex-row bg-cover bg-center" data-aos-duration={1200} data-aos="fade-up" style={{ backgroundImage: `url(${ImagePath}classic/Classic-bg.png)` }}>
