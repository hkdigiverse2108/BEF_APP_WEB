...
const CourseAboutTab = () => {
  return (
    <section className="space-y-6" data-aos="fade-up">
      ...
      <div>
        <button className="flex w-full border border-gray-300 rounded-md hover:text-primary hover:border-primary transition-colors text-center justify-center py-4 gap-3 uppercase font-bold">
