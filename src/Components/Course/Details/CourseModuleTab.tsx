...
const classes = [
  {
    id: 1,
    img: `${ImagePath}workshop/CourseModule.png`,
...
const CourseModuleTab = () => {
  return (
    <div className="space-y-4" data-aos="fade-up">
      {classes.map((cls,i) => (
        <div key={i} className="flex max-sm:flex-col gap-4 bg-white rounded-lg p-4  border border-gray-200 max-sm:items-center ">
          {/* Image */}
