    ...
    <div className="bg-input-box rounded-xl grid grid-cols-1 sm:grid-cols-2 gap-3">
      ...
      <div className="p-3">
        <ReactApexChart
          ...
          series={[Math.round(showChart ? item?.average : 0) || 0]}
          type="radialBar"
          height={250}
        />
      </div>
            ...
            <div className="h-full relative p-3 ps-5 bg-input-box rounded-xl">
              ...
              <div className="text-left">
                <p className="text-lg font-normal capitalize text-neutral-500">
                  {SkipDareReportMessage(
                    Number(SkipDareReport?.fiftyFifty.toFixed(2))
                  )}
                </p>
              </div>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="h-full relative p-3 ps-5 bg-input-box rounded-xl">
              ...
              <div className="text-left">
                <p className="text-lg font-normal capitalize text-neutral-500">
                  {SkipDareReportMessage(
                    Number(SkipDareReport?.direct.toFixed(2))
                  )}
                </p>
              </div>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="h-full relative p-3 ps-5 bg-input-box rounded-xl">
              ...
              <div className="text-left">
                <p className="text-lg font-normal capitalize text-neutral-500">
                  {SkipDareReportMessage(
                    Number(SkipDareReport?.oneEliminate.toFixed(2))
                  )}
                </p>
              </div>
            </div>
