...
import type {
  FirstPoweredReportType,
  FullFestReportSec1Type,
} from "../../Types";
...
const AIPoweredReportAnalysis: FC<{
  ...
  const SubjectReport: FC<{ item: FirstPoweredReportType; title: string }> = ({
    item,
    title,
  }) => (
    <div className="bg-input-box rounded-xl grid grid-cols-1 sm:grid-cols-2 gap-3">
      ...
      <div className="p-3">
        <ReactApexChart
          ...
          series={[Math.round(item?.average) || 0]}
          type="radialBar"
          height={250}
        />
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-3 pt-5">
          ...
          {isLoading ? (
            <Skeleton.Node
              active
              style={{ width: "100%", height: 45, borderRadius: 5 }}
            />
          ) : (
            <div className="h-full relative p-3 ps-5 bg-input-box rounded-xl">
              ...
              <div className="text-left">
                <p className="text-lg font-normal capitalize text-neutral-500">
                  Increase your dare to improve{" "}
                  {SkipDareReport?.fiftyFifty.toFixed(2)} marks.
                </p>
              </div>
            </div>
          )}
          ...
          {isLoading ? (
            ...
            <div className="h-full relative p-3 ps-5 bg-input-box rounded-xl">
              ...
              <div className="text-left">
                <p className="text-lg font-normal capitalize text-neutral-500">
                  By skipping you will save {SkipDareReport?.direct.toFixed(2)}{" "}
                  marks.
                </p>
              </div>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="h-full relative p-3 ps-5 bg-input-box rounded-xl">
              ...
              <div className="text-left">
                <p className="text-lg font-normal capitalize text-neutral-500">
                  By daring you will increase{" "}
                  {SkipDareReport?.oneEliminate.toFixed(2)} marks.
                </p>
              </div>
            </div>
          )}
