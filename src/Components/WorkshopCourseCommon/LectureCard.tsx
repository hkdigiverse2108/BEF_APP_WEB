    ...
    >
      ...
      <section className="flex max-sm:justify-between  items-end ">
        ...
        {lecture?.pdf && (
          <a
            href={lecture?.pdf}
            className="flex gap-2 py-1 px-2  h-fit items-center  hover:text-primary border border-gray-200 hover:border-primary rounded max-sm:text-xs sm:ont-medium transition duration-200  "
          >
