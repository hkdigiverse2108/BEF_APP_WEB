          ...
          <thead>
            <tr className="bg-gray-100 border-b border-gray-300">
              {headers.map((header, i) => (
                <th key={i} className={`px-4 py-2 text-left font-bold border-gray-300 ${i === headers.length - 1 ? "" : "border-e"}`}>
                  {header}
                </th>
              ))}
              <th className="px-4 py-2 text-center font-bold w-[120px] border-l border-gray-300">Check</th>
            </tr>
          </thead>
