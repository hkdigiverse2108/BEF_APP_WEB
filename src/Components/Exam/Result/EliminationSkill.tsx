...
const EliminationSkill: FC<{ data: Sec3Type; subjectName: string; TabIndex: number }> = ({ data, subjectName, TabIndex }) => {
  ...
  const eliminationReport = showChart ? (tabIndex === 0 ? metrics?.fiftyFifty : metrics?.oneEliminate) :{ correctPercentage: 0, incorrectPercentage: 0 };
  ...
  return (
    <>
      <div className="relative pl-4 mb-6">
        ...
        <h2 className="text-xl font-semibold text-gray-800">Elimination Skill Report</h2>
